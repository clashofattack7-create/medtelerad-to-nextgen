...
for t in ['report_description', 'report_impression', 'report_title', 'report_prepared_by', 'ReportCreation', 'reportCreation', 'registration_id', 'order_id', 'service_id', 'fb.group', 'FormGroup']:
    ctx(t)
