...
def ctx(token, width=900, maxh=4):
    print(f'\n===== {token} =====')
...
for t in ['ReportCreation(', 'findings', 'impression', 'report_text', 'clinical_history', 'reportContent', 'reportData', 'orderId', 'registrationId', 'serviceId']:
    ctx(t)
